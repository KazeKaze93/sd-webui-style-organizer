...
**Method:** POST  
**Description:** Increments usage counters for the provided style names. Writes are serialized with a `threading.Lock` so concurrent live-apply POSTs cannot lose counts.
